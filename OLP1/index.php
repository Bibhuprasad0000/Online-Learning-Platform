...
<div class="container main-con">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8 col-sm-10 p-5">
            <form class="bg-white rounded p-4 p-md-5 signup-form">
                <h1 class="text-center bold">Welcome To OLP <br>Sign Up</h1>
            ...
            <form class="bg-white rounded p-4 p-md-5 activation-form d-none" autocomplete="off">
  ...
  $(document).ready(function () {
    ...
    $(".activation-form").submit(function (e) {
      ...
      $.ajax({
        ...
        success:function(response)
        {
          $(".activation_code").html("Activate Now!");
